...
*   **[.claude/](file:///Users/mariocasanova10pa/Documents/Universal%20Harness/.claude/)**: Claude Code integration — the agent bench (*mesa de internos*: orchestration-planner, substrate-worker, harness-verifier, evolution-analyst, research-librarian), observability + lock-enforcement hooks in `settings.json`, and the `harness-status` skill.
*   **[prompts para Gemini/](file:///Users/mariocasanova10pa/Documents/Universal%20Harness/prompts%20para%20Gemini/)**: The Gemini prompt bridge — numbered, self-contained hand-off prompts (`1.md`, `2.md`, …) written by the coordinator for the human to paste into Antigravity; outputs return to the blackboard.
